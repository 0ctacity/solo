...
This folder contains **pending release notes** for `@solo/native` and `@solo/react`. Each `.md` file describes one user-facing fix or feature that should appear in the next generated changelog.

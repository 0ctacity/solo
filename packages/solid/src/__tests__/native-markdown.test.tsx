...
/// Faithful port of packages/react/src/__tests__/markdown.test.tsx.
...
const DOC = [
  "# GPUIX",
  "",
  "Build **native** desktop apps with *Solid*, rendered on the `GPU`.",
  "",
  "## Features",
  "",
  ...
  "- Virtualized diffs",
  "",
  "> Immediate mode aligns with Solid's model.",
  "",
  "```ts",

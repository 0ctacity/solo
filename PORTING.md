...
- markdown.test.tsx         → native-markdown.test.tsx (15 tests)
- virtual-list.test.tsx     → native-virtual-list.test.tsx (8 tests)
- selection.test.tsx        → native-selection.test.tsx
- selection-layout.test.tsx → native-selection-layout.test.tsx (+ custom-element click targets)
